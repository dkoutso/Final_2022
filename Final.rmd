...
The odds ratio tells us that the males that take the vaccine have 1.7 chances to not contract the virus as compared to those that took the placebo .  
...
### Females Conclusion
to conclude, since from the analysis and the drug efficacy(58.8%)it is seen that the females that take the vaccine are more likely to not contract the the vaccine,so I recommend that the subgroup females should use the vaccine.    
...
The odds ratio tells us there are 1.43 chances that the vaccine has a great effect of preventing the LGBTQ subgroup from getting covid19.  
...
On the fisher's exact test, the odds ratio says that there is 0.017 chance that the vaccine have no effect on either the drug users.     
